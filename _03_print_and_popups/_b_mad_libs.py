...
if __name__ == '__main__':
    ...
    adjective=simpledialog.askstring(title='Greeter', prompt= "Enter an adjective here")
    # Get the player to enter a type of liquid
    liquid=simpledialog.askstring(title='Greeter', prompt= "Enter a type of liquid here")
    # Get the player to enter a body part
    bodypart=simpledialog.askstring(title='Greeter', prompt= "Enter a body part here")
    # Get the player to enter a verb
    verb=simpledialog.askstring(title='Greeter', prompt= "Enter a verb here")
    # Get the player to enter a place
    place=simpledialog.askstring(title='Greeter', prompt= "Enter a place here")
